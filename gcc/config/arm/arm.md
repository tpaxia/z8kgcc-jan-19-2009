...
(define_insn "cond_call"
  [(compare:CC (match_operand:SI 0 "s_register_operand" "r")
   ...
   (match_operator 3 "comparison_operator" [(reg 24) (const_int 0)])
   (clobber (reg:CC 24))
   (clobber (reg:SI 14))]
...
(define_expand "movsi"
  ...
  if (! ok_integer_or_other (operands[1])) /* CYGNUS LOCAL nickc */
    {
  ...
  "
{
  ...
  else if (! ok_integer_or_other (operands[1])) /* CYGNUS LOCAL nickc */
    {
...
;; Store before load to avoid problem with reload.
(define_insn "*movhi_insn_arch4"
  [(set (match_operand:HI 0 "general_operand" "=r,r,m,r")    ;; CYGNUS LOCAL nickc
	(match_operand:HI 1 "general_operand"  "rI,K,r,m"))] ;; CYGNUS LOCAL nickc
  "arm_arch4
