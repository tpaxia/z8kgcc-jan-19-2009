...
(define_attr "cpu" "v7,cypress,v8,supersparc,sparclite,f930,f934,hypersparc,sparclite86x,sparclet,tsc701,v8plus,v9,ultrasparc"
  ...
  "*
{
  ...
  if (GET_CODE (op1) == CONST_INT)
    {
      operands[0] = WORDS_BIG_ENDIAN ? operand_subword (op0, 1, 0, DImode)
				     : operand_subword (op0, 0, 0, DImode);
      output_asm_insn (\"sethi %%hi(%a1),%0\", operands);

      operands[0] = WORDS_BIG_ENDIAN ? operand_subword (op0, 0, 0, DImode)
