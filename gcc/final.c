  ...
  for (insn = NEXT_INSN (first); insn;)
    {
	 ...
	 some insn, e.g. sh.c output_branchy_insn.
         ...
         We don't care about the actual address computed in that case,
	 so this is safe.

	 Also, this is a progressive 98r1 patch only.  This will be fixed
	 differently for devo.  */
