     ...
     rtx x;
{
  ...
  int override = 0;  /* 16-Jun-2007, chris: flag to ignore PSImode and SImode difference */
  ...
  if (mode == PSImode && GET_MODE (x) == SImode)
    {
      warning ("32bit variable used as memory index -- may be problematic");
      override = 1;
    }
  else
